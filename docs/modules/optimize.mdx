...
<Warning>
  Requantizing an already-quantized model produces worse results than quantizing from a high-precision source.
</Warning>
...
The original model is never modified — output is a new GGUF file.
