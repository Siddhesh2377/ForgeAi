...
description: "GGUF and SafeTensors format support across all ForgeAI modules"
icon: "file"
---

# Supported Formats

ForgeAI works with two primary model formats: **GGUF** and **SafeTensors**.
...
| Optimize | Quantize to any level |
...
| Inspect | Full analysis |
| Optimize | Not supported (convert to GGUF first) |
| Hub | Download from HuggingFace |
